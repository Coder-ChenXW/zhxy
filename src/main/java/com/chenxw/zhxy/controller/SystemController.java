...
public class SystemController {
    ...
    public Result headerImgUpload(
        ...
        String portraitPath = "E://project//java//springboot//zhxy//src//main//resources//public//upload//".concat(newFileName);
        try {
